...
def test_source_zip_allowlist_and_no_overwrite(tmp_path):
    ...
    with zipfile.ZipFile(target) as z:
        ...
        assert 'something_finder/src/ctf_mcp/targets.py' in names
        assert 'something_finder/src/ctf_mcp/full_hunt/bisect.py' in names
        assert 'something_finder/src/ctf_mcp/full_hunt/disclosure.py' in names
        assert 'something_finder/docs/TARGET_SDK.md' in names
        assert 'something_finder/docs/VERSION_BISECT.md' in names
        assert 'something_finder/docs/DISCLOSURE_PACK.md' in names
