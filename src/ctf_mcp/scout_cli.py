...
def run(args, settings):
    ...
    elif action == "feedback": result = controller.reconcile_feedback(args.program)
    elif action == "graph": result = controller.graph_status(args.program, args.proposal)
    elif action == "experiment": result = controller.plan_experiment(args.id)
    elif action == "explain": result = controller.explain(args.id)
