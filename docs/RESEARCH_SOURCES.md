...
| [Codex CLI](https://registry.npmjs.org/@openai/codex/0.155.0) | 0.155.0 | Pinned CLI for ChatGPT-backed agent. Version/help/config/skill discovery executed.  [build_dependency_not_vendored] | Apache-2.0 per npm metadata; preserve package notices in images. |
